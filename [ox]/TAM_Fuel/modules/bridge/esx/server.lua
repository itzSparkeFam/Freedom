...
function bridge.notify(source, description, type, duration)
    lib.notify(source, {description = description, type = type, duration = duration or 5000})
end

---Remove Money
---@param source integer
---@param price integer
function bridge.removeMoney(source, price)
...
---@param price integer
---@return boolean
function bridge.getMoney(source, price)
    local player = ESX.GetPlayerFromId(source)
