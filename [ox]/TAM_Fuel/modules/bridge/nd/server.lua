...
function bridge.notify(source, description, type, duration)
    ...
    player.notify(source, description, type, duration)
end
...
function bridge.removeMoney(source, price, type)
    -- local player = NDCore.getPlayer(source)
    NDCore.Functions.DeductMoney(price, source, type, "Fuel Costs")
    -- player.deductMoney('bank', price, "Fuel Costs")
end
