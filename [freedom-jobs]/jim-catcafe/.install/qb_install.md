...
---
# Item installation
- Add the images from .install/images to your inventory folder eg. `ps-inventory > html > images`

- If using `ox_inventory` add the `ox_items.lua` to your `ox_inventory > data > items.lua`

- If using `ps-inventory` or similar, add the lines from `qb_items.lua` to your `qb-core > shared > items.lua`
