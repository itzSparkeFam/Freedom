...
--This will group different jobs together. Eg., so 2 jobs {'police', 'ambulance'} can both see can see each other on the dispatch UI and the pause menu/mini-map blips.
    [1] = {'police'}, --police & ambulance group
    [2] = {'ambulance'}, --mechanic group
...
Config.PanicButton = {
    ...
    key = 'RSHIFT', --The key press. This is not used by default. You can choose keys here - https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/.
    job_table = {'police', 'sasp',  'ambulance' }, --A list of jobs who can use the panic button. (every job in this list will be notified if a panic button is pressed).
...
Config.Ping = {
    ...
    key = 'NUMPAD7', --The key press. You can choose other keys here - https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/.
...
Config.PoliceAlerts = {
    ...
    police_jobs = {'police','sasp', }, --The jobs who will be notified from these police alerts.
    ...
    require_witness_peds = {
        ...
        distance = 50, --The distance to check for witnesses.
    },
...
Config.small_ui = {
    ...
    key = 'N' --The key press. You can choose other keys here - https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/.
}
...
Config.move_mode = {
    ENABLE = false, --Do you want to enable the move mode feature?
    command = ''
}

Config.small_ui_left = {
    ENABLE = false, --Do you want to enable the small UI left scroll?
    command = 'scrollleft', 
    key = ''
}

Config.small_ui_right = {
    ENABLE = false, --Do you want to enable the small UI right scroll?
    command = 'scrollright', 
    key = ''
}
