...
-- Check for Config.CheckForItem.Item in the players inventory before getting a run. If Consume.Enable is true then, based off of Consume.Chance, the item in question will be removed.
Config.CheckForItem = { Enable = false, Item = "vpn", Consume = { Enable = false, Chance = 50 } }
...
-- Configuration for the minigame that's used when the buyer attempts to rob you of your package without giving you oxy. Refer to Config.Levels[i].Robbery for more information.
Config.Minigame = {
...
Config.Levels = {
    ...
    [1] = {
        ...
        ItemReward = { Item = "oxy", Min = 3, Max = 5 }, -- Rewards for Level 1
        ...
        RareItem = { Enable = true, Chance = 5, Reward = { Items = { "advancedlockpick", "security_card_01" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 1
    ...
    [2] = {
        ...
        ItemReward = { Item = "oxy", Min = 5, Max = 7 }, -- Adjusted Rewards for Level 2
        ...
        RareItem = { Enable = true, Chance = 8, Reward = { Items = { "advancedlockpick", "security_card_02" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 2
    ...
    [3] = {
        ...
        CallCopsChance = 90, -- Chance for the cops to be called when a player delivers a package.
        ItemReward = { Item = "oxy", Min = 7, Max = 10 }, -- Adjusted Rewards for Level 3
        ...
        RareItem = { Enable = true, Chance = 12, Reward = { Items = { "security_card_oil", "security_card_02" }, Min = 1, Max = 1 } }, -- Rare Item Reward for Level 3
