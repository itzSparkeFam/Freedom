...
Config.Discord = {
    ...
    applicationId = '1265724474548949033',                   -- The discord application id
    iconLarge = '512x512',                               -- The name of the large icon
    iconLargeHoverText = '', -- The hover text of the large icon
    iconSmall = 'fivemicon',                         -- The name of the small icon
    ...
    buttons = {
        {
            text = 'Join OakHaven Discord',
            url = 'https://discord.gg/Y6WAvzkKrF'
        },
        {
            text = 'Join the Server',
            url = 'fivem://connect/cfx.re/join/e9dzad'
        }
    }
}
