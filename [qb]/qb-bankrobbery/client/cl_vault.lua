local Laser1 = Laser.new(
    vector3(259.906, 229.711, 103.772),
    {vector3(255.549, 234.133, 100.683), vector3(257.374, 231.657, 100.683), vector3(253.942, 230.824, 100.683)},
    {travelTimeBetweenTargets = {1.0, 1.0}, waitTimeAtTargets = {0.0, 0.0}, randomTargetSelection = true, name = "lowervault1"}
)
local Laser2 = Laser.new(
    vector3(247.704, 233.616, 104.165),
    {vector3(256.85, 230.513, 100.683), vector3(256.461, 234.034, 101.463), vector3(251.25, 240.455, 100.683), vector3(252.001, 236.034, 100.683)},
    {travelTimeBetweenTargets = {1.0, 1.0}, waitTimeAtTargets = {0.0, 0.0}, randomTargetSelection = true, name = "lowervault2"}
)
local Laser3 = Laser.new(
    vector3(251.619, 241.131, 104.699),
    {vector3(249.331, 231.798, 101.505), vector3(254.754, 233.652, 100.683), vector3(258.954, 236.069, 100.683), vector3(251.435, 235.654, 100.683)},
    {travelTimeBetweenTargets = {1.0, 1.0}, waitTimeAtTargets = {0.0, 0.0}, randomTargetSelection = true, name = "lowervault3"}
)
local Laser4 = Laser.new(
    vector3(262.562, 237.01, 104.528),
    {vector3(247.755, 233.758, 101.268), vector3(249.672, 239.023, 101.412), vector3(253.88, 237.109, 100.683)},
    {travelTimeBetweenTargets = {1.0, 1.0}, waitTimeAtTargets = {0.0, 0.0}, randomTargetSelection = true, name = "lowervault4"}
)
