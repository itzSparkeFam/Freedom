...
local Vehicles = {
    ...
    { model = 'w463',          name = 'w463',                            brand = 'merc',     price = 22000,   category = 'suvs',                  type = 'automobile', shop = 'luxury' },
    --- Coupes (3)
    ...
    --- Sports (6)
    { model = 'silvia666',     name = 'silvia666',                     brand = 'silvia666',       price = 0,       category = 'sports',         type = 'automobile', shop = 'luxury' },
    ...
    { model = 'P1',            name = 'P1',                            brand = 'mclaren',         price = 0,   category = 'sports',             type = 'automobile', shop = 'luxury' },
    ...
    --- Emergency (10)
    { model = 'f450towtruk', name = 'f450towtruk',             brand = 'f450towtruk',          price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'poltowtruck', name = 'poltowtruck',             brand = 'poltowtruck',          price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvccjv', name = 'Vapid Caracara',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvajv', name = 'Vapid Aleutian',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pbbjv', name = 'Bravado Buffalo STX',     brand = 'Buffalo',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pdglxjv', name = 'Declasse Granger 3600XL',     brand = 'Declasse',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvcjv', name = 'Vapid Stanier LE Cruiser',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvdtrt', name = 'Vapid Dominator TRT',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvsjv', name = 'Vapid Scout',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pvtjv', name = 'Vapid Torrence',     brand = 'Vapid',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'sphijv', name = 'HVY Insurgent',     brand = 'HVY',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'spvhjv', name = 'Buckingham Valkyrie',     brand = 'Buckingham',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pbbgtsj', name = 'Police Banshee',     brand = '',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'pksrsjv', name = 'Sultan RS',     brand = 'Karan',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'spbbjv', name = 'Buffalo STX S',     brand = 'Bravado',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'gresleyhellfirepd', name = 'Gresley Hellfire',     brand = 'Bravado',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'mtlfireheavy', name = 'MTL Heavy Truck',     brand = 'MTL',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'mtlfireladder', name = 'MTL Ladder Truck',     brand = 'MTL',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'mtlfiretruck', name = 'MTL Fire Truck',     brand = 'MTL',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'vapidsandstorm', name = 'Sandstorm D205 6x6',     brand = 'Sandstorm',           price = 0,        category = 'emergency',         type = 'automobile', shop = 'none' },
    { model = 'vapidspeedoambulance', name = 'Ambulance Van',     brand = 'Vapid',           price = 0,        category = 'ems',         type = 'automobile', shop = 'none' },
    { model = 'GiratiEms', name = 'Grotti Itali GTO',     brand = 'Grotti',           price = 0,        category = 'ems',         type = 'automobile', shop = 'none' },
    { model = 'RaviertEms', name = 'Gallivanter Baller',     brand = 'Gallivanter',           price = 0,        category = 'ems',         type = 'automobile', shop = 'none' },
    { model = 'ReepEms', name = 'Reep Track-Bird',     brand = 'Reep',           price = 0,        category = 'ems',         type = 'automobile', shop = 'none' },
    ...
    { model = 'formula',       name = 'PR4',                           brand = 'Progen',          price = 100000,  category = 'openwheel',      type = 'automobile', shop = 'none' },
     --- Imports (23)
    { model = 'dowgauntlets',  name = 'DoW Gauntlet S',                brand = 'Bravado',        price = 1000000,  category = 'muscle',       type = 'automobile', shop = 'none' },
    { model = 'Coastline',     name = 'Coastline',                     brand = 'None',           price = 0,        category = 'coupe',        type = 'automobile', shop = 'none' },
    { model = '23rs7',         name = '23rs7',                         brand = 'None',           price = 0,        category = 'coupe',        type = 'automobile', shop = 'none' },
    { model = 'cycloneex0',    name = 'cycloneex0',                    brand = 'None',           price = 0,        category = 'coupe',        type = 'automobile', shop = 'none' },
    { model = 'DB25C8SUV',     name = 'DB25C8SUV',                     brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'AQV',           name = 'AlfaRomeo_Giulia',              brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = '124spider',     name = 'Abarth_124',                    brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = '155q4',         name = 'AlfaRomeo_155_Q4',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'db11',       name = 'AstonMartin_DB11',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'ast',       name = 'AstonMartin_Vanquish',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'vantage',       name = 'AstonMartin_Vantage',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'a6',       name = 'Audi_A6_2020',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'a8lfsi',       name = 'Audi_A8_LFSI',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'q820',       name = 'Audi_Q8_2020',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'r820',       name = 'Audi_R8_2020',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rs318',       name = 'Audi_Rs3_2018',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'audirs4',       name = 'Audi_RS4_2001',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'RS5',       name = 'Audi_RS5',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rs62',       name = 'Audi_RS6_2020',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rrst',       name = 'Range Rover',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'r35',       name = 'GTR R35',                       brand = 'None',           price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'skyline',       name = 'GTR R34',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'GDWRXSTI',       name = 'WRX STI',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'c7',       name = 'Corvette C7',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'zl12017',       name = 'Camaro Zl71',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DBfreebochapler', name = 'DBfreebochapler',             brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DBGODz9ELEVEN', name = 'DBGODz9ELEVEN',                 brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DBlcr34pd', name = 'DBlcr34pd',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DBmonog63', name = 'DBmonog63',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DBugc24gt', name = 'Mustang 1 of 1',                    brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'DEFENDER21', name = 'Defender 1 of 1',                  brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'deluxowb', name = 'Deluxe',                             brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'durangobeast', name = 'Durango Import',                 brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'ecf350plat', name = 'Debadged Plat',                    brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'g81hr', name = 'g81hr',                                 brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'goldwing', name = 'goldwing',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'gt3demon', name = 'gt3demon',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'gtr50', name = 'gtr50',                                 brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'm720', name = 'm720',                                   brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'NMCTSV', name = 'NMCTSV',                               brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'pd_avent', name = 'pd_advent',                          brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rrphantom', name = 'Phantom',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_bmwe36', name = 'Mini BMW',                          brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_bugatti', name = 'Mini Bugatti',                     brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_bugvr', name = 'Mini Bugvr',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_dawn', name = 'Mini dawn',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_gtr', name = 'Mini Gtr',                             brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_jeep', name = 'Mini Jeep',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_lgss', name = 'Mini Lgss',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_rover', name = 'Mini Rover',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_sianr', name = 'Mini Sianr',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'PV_urus', name = 'Mini Urus',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'r8hycade', name = 'Debadged Hycade',                    brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'revp50demo', name = 'revp50demo',                       brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rmodmustang', name = 'rmodmustang',                     brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rsq3spoon', name = 'rsq3spoon',                         brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rsq8m', name = 'rsq8m',                                 brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'rx7v', name = 'rx7v',                                   brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'sandkingd', name = 'sandking 1 of 1',                   brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'sunrise1', name = 'sunrise1',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'turismoc', name = 'turismoc',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'venatusc', name = 'venatusc',                           brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'w223b50', name = 'w223b50',                             brand = 'None',           price = 0,        category = 'suvs',         type = 'automobile', shop = 'none' },
    { model = 'gstfmj1',      name = 'Gstfmj',                        brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'cometven', name = 'Cometven',                          brand = 'Comet',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gtcoupe',    name = 'GT Coupe',                        brand = 'Dominator',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'kurxa19', name = 'kurxa19',                            brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstsul1',    name = 'gtsul1',                          brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gtzen1',     name = 'Zentorno ',                       brand = 'Pregrassi',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'sunriser1',  name = 'Sunrise',                         brand = 'Sunrise',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'elegy3', name = 'elegy3',       brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstcs21', name = 'gstcs21',       brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstzr3502', name = 'gstzr3502',      brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstfac1', name = 'gstfac1',      brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstyxl3', name = 'gstyx13',      brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstt203', name = 'gstt203',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'Rhinehart', name = 'Rhinehart',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstbhell1', name = 'gstbhell1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstbls1', name = 'gstbls1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstcdy1', name = 'gstcdy1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstcyp1', name = 'gstcyp1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstgrs1', name = 'gstgrs1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstjc3', name = 'gstjc3',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstnio1', name = 'gstnio1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstch1', name = 'gstch1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'gstter1', name = 'gstter1',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },
{ model = 'chevaldominator', name = 'chevaldominator',     brand = '',        price = 1000000,  category = 'sport',       type = 'automobile', shop = 'none' },


    --- Gold1of1 (32)
    { model = '23Demon170R1500D', name = '23Demon170R1500D',           brand = 'dodge',           price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'm720', name = 'm720',                                   brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'DBfreebochalper', name = 'FIVEMCAR.COM',                brand = 'FIVEMCAR.COM',    price = 1,        category = '20',         type = 'automobile', shop = 'luxury'},
    { model = 'DBgmchycade', name = 'GMC Debadged',                    brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'DBGODzZEE28WB', name = 'DBGODzZEE28WB',                 brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'DBlaferraribeast',  name = 'DBlaferraribeast',          brand = 'FIVEMCAR.COM',    price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'es-v4rs',       name = 'es-v4rs',                       brand = 'es-v4rs',         price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'GODzS2kPNDMCR',  name = 'GODzS2kPNDMCR',                brand = 'Honda',           price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'ksd',           name = 'ksd',                           brand = 'Ktm',             price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'huracanpriorbeast',  name = 'huracanpriorbeast',        brand = 'Lamborghini',     price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'redeye',         name = 'redeye',                       brand = 'dodge',           price = 23500,    category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'ugcgt24',       name = 'ugcgt24',                       brand = 'Dodge',           price = 0,        category = '20',         type = 'automobile', shop = 'luxury' },
    { model = 'TSGR20',       name = 'Supra MK5',                      brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'wraith', name = 'wraith',                               brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'Yamr1crone', name = 'Yamr1crone',                       brand = 'kawasaki',        price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'gxraptor', name = 'gxraptor',                           brand = 'ford',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'rsq8mans', name = 'RSQ8',                               brand = 'Audi',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'morhawk', name = 'Demon Hawk',                          brand = 'Jeep',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'mansrx8', name = 'RX8',                                 brand = 'Audi',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'FK8',    name = 'Honda_Civic_TypeR_2017',               brand = 'None',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'CCrs',   name = 'CCrs',                                 brand = 'CCrs',            price = 0,        category = '20',         type = 'automobile', shop = 'none' },
    { model = 'rs322',   name = 'rs322',                               brand = 'rs322',           price = 0,        category = '20',      type = 'automobile', shop = 'none' },
    { model = '24zx10r',   name = '24zx10r',                           brand = 'KAWASAKI',        price = 0,        category = '20',    type = 'automobile', shop = 'none' },
    { model = 'ToraChironTTWB',   name = 'ToraChironTTWB',             brand = 'Bugatti',         price = 0,        category = '20',    type = 'automobile', shop = 'none' },
    { model = 'ikx3_r823',   name = 'ikx3_r823',                       brand = 'ikx3_r823',       price = 0,        category = '20',    type = 'automobile', shop = 'none' },
    { model = 'DBanimctswideels',      name = 'DBanimctswideels',      brand = 'FIVEMCAR.COM',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'DB21ramtrx',    name = 'DB21ramtrx',                    brand = 'FIVEMCAR.COM',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'gtfreerelease',    name = 'gtfreerelease',                    brand = 'gtfreerelease',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'M3BXANE',    name = 'M3BXANE',                    brand = 'BMWG80',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'wladlc500',    name = 'wladlc500',                    brand = 'LC500',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'stingray',    name = 'stingray',                    brand = 'chevy',    price = 0,       category = '20',      type = 'automobile', shop = 'none' },
    { model = 'DBsou_chargerdem',   name = 'DBsou_chargerdem',  brand = 'FIVEMCAR.COM',  price = 0,  category = '20',      type = 'automobile', shop = 'none' },
    { model = 'DBA1CTSV',   name = 'DBA1CTSV',  brand = 'FIVEMCAR.COM',  price = 0,  category = '20',      type = 'automobile', shop = 'none' },
    { model = 'DBugcctsv',   name = 'DBugcctsv',  brand = 'FIVEMCAR.COM',  price = 0,  category = '20',      type = 'automobile', shop = 'none' },
    { model = 'DB2022jeep', name = 'DB2022jeep', brand = 'Jeep', price = 0, category = '20', type = 'automobile', shop = 'none'},
    { model = 'A1CT5', name = 'A1CT5', brand = 'CT5', price = 0, category = '20', type = 'automobile', shop = 'none'},
    { model = 'DBwidekit2023gt63d', name = 'GT63D', brand = 'GT63D', price = 0, category = '20', type = 'automobile', shop = 'none'},
    { model = 'zm_hycsun', name = 'LEO HYCADE', brand = 'Mitsubishi', price = 0, category = '20', type = 'automobile', shop = 'none'},
