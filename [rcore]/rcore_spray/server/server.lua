...
AddEventHandler('rcore_spray:addSpray', function(spray, sprayCoordsToRemove)
    local Source = source
    ...
    if spray.text or spray.image then
        if Framework == FW_OTHER then
            ...
            if RemoveOnOverlap and sprayCoordsToRemove then
                RemoveSprayAtPosition(Source, sprayCoordsToRemove)
            end
