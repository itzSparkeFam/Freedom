...
function PersistSpray()
    ...
    if rayEndCoords and rayNormal then
        ...
        TriggerServerEvent('rcore_spray:onSprayStarted', sprayLocation, finalText)
        TriggerEvent('rcore_spray:onSprayStarted', sprayLocation, finalText)
        ...
        CancellableProgress(
            ...
            function() -- success
                ...
                local sprayCoordToRemove = nil

                if RemoveOnOverlap and IsOverlappingSpray(currentComputedLocation) then
                    sprayCoordToRemove = GetClosestSprayCoords(currentComputedLocation)
                end
