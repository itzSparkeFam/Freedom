...
Locale['EN'] = {
    ...
    ACTION_TARGET_RESTRAIN_COOLDOWN = "Please wait to restrain another player",
    ...
    DISCORD_NEW_OWNER_NAME = "New zone owner",

    ALREADY_SELLING_DRUGS = "Please wait to finish your current sale.",
    CANT_SELL_DRUGS_IN_CAR = "You can't make a sale in a car",
}