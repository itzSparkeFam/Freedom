...
-- 9 = CodeM Inventory (codem-inventory)
-- 10 = TGIANN Inventory (tgiann-inventory)
Config.Inventory = 2
...
-- 6 = CodeM Dispatch (codem-dispatch)
-- 7 = Origen Dispatch (origen_police)
Config.Dispatch = 1
...
Config.ZoneOptions = {
    ...
    showHudInfoCommand = "showzoneinfo",
    ...
    maximumMurders = 1, -- The maximum number of murders that affect zone loyalty, each murder resets every hour
...
Config.GangOptions = {
    ...
    maxMembers = 25, -- Maximum number of players in a gang
...
Config.DrugOptions = {
    ...
    saleQuantity = 100, -- How many drugs the player will sell
...
-- this will block every attempts for selling drugs to these specific ped models
...
Config.OtherOptions = {
    ...
    dirtyMoneyAccountName = "black_money", -- account name for the black money

    -- NOTE FOR QBCORE USERS
    -- If your item is using metadata for how much marked money you have
    -- then use the option above, if you're using one item = one dirty dollar then use
    -- this option down below.

    dirtyMoneyItem = false, -- Are you using dirty money as item?
    dirtyMoneyItemName = "black_money", -- Item name for the black money
...
-- Multipliers that decrease the loyalty of a zone during rivalry
Config.DecreaseMultipliersRivalry = {
    HOTWIRE    = 5,
    MURDER     = 10,
    VENDETTA   = 15,
    SPRAY      = 20,
...
Config.Drugs = {
    CATEGORY_LOW = {
        ...
        ['weed_amnesia'] = 550,
        ['weed_og-kush'] = 550,
        ['weed_purple-haze'] = 550,
        ['weed_white-widow'] = 550,
        ['weed_amnesia'] = 550,
        ['weed_purple-haze'] = 550,
        ['weed_gelato'] = 550,
        ['weed_zkittlez'] = 550,
...
Config.GangZones['VCANA'] = {
    ...
    parts = {
        ...
        { x1 = -550.79, y1 = -1174.30, x2 = -1095.41, y2 = -1074.78 },
...
Config.GangZones['VESP'] = {
    ...
    parts = {
        ...
        { x1 = -1450.59, y1 = -1174.30, x2 = -550.79, y2 = -1074.78 },
