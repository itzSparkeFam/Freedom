...
Config.UseRadialMenu = true             -- Enable use of radial menu built in to ox_lib? (REQUIRES OX_LIB 3.0 OR HIGHER - Editable)
...
Config.AmbulanceOffsets = {
    ['sandbulance'] = {            -- Vehicle model name
        ...
        pos = { x = 0.0, y = -3.0, z = 0.00 },
        rot = { x = -1.3, y = 0.0, z = 180.0 }
    },
...
Config.LastStandTickTime = 120 * seconds -- Everytime this time passes while in last stand,
...
Config.FuelSystem = true           -- 'legacy' (LegacyFuel) / 'ox' (ox_fuel) / 'default'

Config.jobMenu = 'F2'               -- Default job menu key
...
Config.EMSItems = {
    ...
    sedate = {
        ...
        duration = 60 * seconds, -- Time sedative effects last
        remove = true           -- Remove item when using?
    },
...
Config.Locations = {
    Pillbox = {
        RespawnPoint = { -- When player dies and bleeds out; they will revive at nearest hospital; Define the coords of this hospital here.
            coords = vec3(322.091, -589.348, 43.99),
            heading = 87.054,
        ...
        Blip = {
            Enabled = true,
            Coords = vec3(307.425, -587.829, 43.284),
            Sprite = 61,
            Color = 2,
            Scale = 1.0,
        ...
        clockInAndOut = {
            ...
            coords = vector3(310.643, -597.105, 43.284), -- Location of where to go on and off duty(If not using target)
            ...
            target = {
                ...
                coords = vector3(310.643, -597.105, 43.284),
                heading = 337.07,
                width = 2.0,
                length = 1.0,
                minZ = 43.28 - 0.9,
        ...
        PersonalLocker = {
            ...
            coords = vector3(-458.686, -1006.317, 23.745),   -- Location of where to access personal locker (If target is disabled)
            ...
            target = {
                enabled = true,                    -- If enabled, the location and distance above will be obsolete
                label = 'Access Locker',
                coords = vector3(-458.686, -1006.317, 23.745),
                heading = 70.18,
                width = 2.0,
                length = 1.0,
                minZ = 43.38 - 0.9,
        ...
        BossMenu = {
            ...
            Coords = vec3(334.784, -594.379, 43.284), -- Location of boss menu (If not using target)
            ...
            Target = {
                ...
                coords = vec3(334.784, -594.379, 43.284),
                heading = 269.85,
                width = 2.0,
                length = 1.0,
                minZ = 43.21 - 0.9,
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vector3(-467.522, -1000.897, 22.7), -- Coords of ped
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            Heading = 82.929,                             -- Heading of ped
            Cost = 1400,                                  -- Cost of using hospital check-in. Set to false for free
            ...
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vector3(-467.522, -1000.897, 18.7),
                heading = 82.929,
                distance = 5.0,
                width = 2.0,
                length = 1.0,
            ...
            RespawnNoBedLocation = { coords = vector3(-475.827, -1000.757, 23.659), heading = 88.366 }, -- Coords and heading of where to spawn player if DisableHospitalBeds is set to true or beds are full
            HospitalBeds = {
                { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(317.67, -585.37, 42.84 + 0.3), heading = 160.0 },
        ...
        Cloakroom = {
            Enabled = true,
            Coords = vec3(300.692, -597.706, 43.284), -- Coords of cloakroom
